export type OpenCodeRuntimeMode = "bundled" | "path" | "external";
...
export const DEFAULT_OPENCODE_CONFIG: OpenCodeRuntimeConfig = { mode: "bundled", externalExecutable: null, workspaceDir: null };
