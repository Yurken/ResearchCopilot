...
export default function OpenCodeWorkspace() {
  ...
  const [draft, setDraft] = useState<OpenCodeRuntimeConfig>(runtime.config);
  useEffect(() => { if (runtime.snapshot && runtime.snapshot.phase !== "running") setDraft(runtime.snapshot.config); }, [runtime.snapshot]);
